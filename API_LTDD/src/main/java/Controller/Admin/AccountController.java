...
public class AccountController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ("search".equals(action)) {
			...
			Account newAccount = new Account(accountId, username, accountType, staffId, customerId, accStatus,
					accPassword);
			try {
			...
			Customer customer = new Customer(null, fullName, email, phoneNumber, imageLink, address, gender, birthDay);
...
//		            jsonResponse.put("account_type", "Customer");
		...
		} else if ("getStaffId".equals(action)) {
			String username = request.getParameter("username");
			try {
				Staff staff = accountDAO.getStaffIdByUsername(username);
				if (staff != null) {
					ObjectMapper obj = new ObjectMapper();
